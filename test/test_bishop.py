...
class TestBishop(unittest.TestCase):
    ...
    def test_bishop_initialization(self):
        ...
        self.assertEqual(bishop.position, (0, 2))
        self.assertEqual(bishop.side, ESide.WHITE)

    def test_get_position(self):
        bishop = Bishop((3, 3), ESide.WHITE)
        self.assertEqual(bishop.get_position(), (3, 3))

    def test_go_to_position(self):
        bishop = Bishop((3, 3), ESide.WHITE)
        bishop.go_to_position((4, 4))
        self.assertEqual(bishop.get_position(), (4, 4))
    ...
    def test_available_moves_empty_board(self):
        ...
        for start_row, start_col, expected_positions in test_cases:
            bishop = Bishop((start_row, start_col), ESide.WHITE)
    ...
    def test_available_moves_with_blockage(self):
        bishop = Bishop((3, 3), ESide.WHITE)
        blocking_piece = TChessman(EChessmanType.PAWN, (4, 4), ESide.WHITE)
    ...
    def test_available_moves_capturing(self):
        bishop = Bishop((3, 3), ESide.WHITE)
        enemy_piece = TChessman(EChessmanType.PAWN, (4, 4), ESide.BLACK)
    ...
    def test_bishop_with_mixed_blockage(self):
        bishop = Bishop((3, 3), ESide.WHITE)
        ally_piece = TChessman(EChessmanType.PAWN, (4, 4), ESide.WHITE)
        self.chessboard.get_field(4, 4).occupied_by = ally_piece
        enemy_piece = TChessman(EChessmanType.PAWN, (2, 4), ESide.BLACK)
    ...
    def test_bishop_capturing_multiple_pieces(self):
        bishop = Bishop((3, 3), ESide.WHITE)
        enemy_piece_1 = TChessman(EChessmanType.PAWN, (5, 5), ESide.BLACK)
        enemy_piece_2 = TChessman(EChessmanType.PAWN, (1, 5), ESide.BLACK)
